...
const userSchema = new mongoose.Schema({
  ...
  staffPermissions: { type: [String], enum: ['users_manage', 'users_delete', 'roles_manage', 'credits_manage', 'verification_manage', 'payments_manage', 'cases_manage', 'security_view'], default: [] },
